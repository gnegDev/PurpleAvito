...
> [!WARNING]  
> В связи с тем, что решение полагается на Yandex Cloud AI Assistants с уже настроенными агентами, для запуска вам потребуется определенный API-ключ (YANDEX_CLOUD_API_KEY). Свяжитесь с нами для его получения.
